...
<html lang="es">
    ...
    <nav class="navbar navbar-light justify-content-between" style="background-color:#e3f2fd;">
        ...
        <h2 align='left'>Agregar intervención</h2><br>
          ...
          <?php
           while($row = $resultado->fetch_assoc()){?>
              <tr> 
                ...
                <a href="agregar_clin_medica.php&id=<?php echo $row['id']?>" class="btn btn-info btn-sm" title="Agregar Int. Cl. Médica"><i class="far fa-notes-medical"></i></a>

                <!--<a href="eliminar_solicitud.php?id=<?php echo $row['id']?>" class="btn btn-warning btn-sm" title="Agregar Int. Psicológica"><i class="fas fa-brain"></i></a>

                <a href="eliminar_solicitud.php?id=<?php echo $row['id']?>" class="btn btn-light btn-sm" title="Agregar Int. Cardiológica"><i class="far fa-heartbeat"></i></a> -->
