...
<div class="container mt-5 bg-light">
    ...
    <a href="index.php?id=78858&fun=nt27&dni=<?php echo $idni;?>"><button type="submit" class="btn btn-secondary float-right my-2 mx-5" value="Actualizar Historial">Editar Datos Personales</button></a>
    <br> <br>    <br> 
...
<form action="funciones.php?fun=nt25&name=<?php echo $name;?>" method="post">
    <div class="container mt-5 bg-light">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" class="form-control" name="inputDescripcion" placeholder="El paciente ahora es..."></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" class="form-control" name="inputPatologias" placeholder="El paciente ahora tiene..."></textarea>
        </div>
        <div class="form-group">
